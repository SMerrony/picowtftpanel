...
/***
 * N.B. Image mutex locking is performed here at the STRING level, not per character/pixel.
 *      If we were showing moving graphics, this might need to be revisited.
*/
